...
abstract class Client extends ClientBase {
  core.String basePath = "/doubleclickbidmanager/v1/";
  ...
  LineitemsResource_ get lineitems => new LineitemsResource_(this);
  QueriesResource_ get queries => new QueriesResource_(this);
